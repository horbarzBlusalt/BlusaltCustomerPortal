...
WebUI.click(findTestObject('Object Repository/BulkNIN_OR/Page_Blusalt - Start Testing your services/a_Download this template'))
...
WebUI.click(findTestObject('Object Repository/BulkNIN_OR/Page_Blusalt - Start Testing your services/div_Phone Number'))

WebUI.click(findTestObject('Object Repository/BulkNIN_OR/Page_Blusalt - Start Testing your services/li_NIN Number'))

WebUI.click(findTestObject('Object Repository/BulkNIN_OR/Page_Blusalt - Start Testing your services/span_Verify NINs'))

WebUI.click(findTestObject('Object Repository/BulkNIN_OR/Page_Blusalt - Start Testing your services/p_Your file is Successfully Uploaded'))
