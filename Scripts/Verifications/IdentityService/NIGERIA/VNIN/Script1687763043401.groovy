...
WebUI.click(findTestObject('Object Repository/VNIN_OR/Page_Blusalt - Start Testing your services/a_Virtual National Identity Number (vNIN)'))

WebUI.click(findTestObject('Object Repository/VNIN_OR/Page_Blusalt - Start Testing your services/span_Verify vNIN'))

WebUI.setText(findTestObject('Object Repository/VNIN_OR/Page_Blusalt - Start Testing your services/input__vti__input'), 
    '08175885645')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/VNIN_OR/Page_Blusalt - Start Testing your services/p_This service is not included in your app'), 
    0)
