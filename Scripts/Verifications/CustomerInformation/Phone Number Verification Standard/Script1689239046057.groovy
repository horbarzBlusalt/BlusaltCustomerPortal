...
WebUI.click(findTestObject('Object Repository/PhoneNumberStand_OR/Page_Blusalt - Welcome to your dashboard/a_Verifications'))

WebUI.click(findTestObject('Object Repository/PhoneNumberStand_OR/Page_Blusalt - Welcome to your dashboard/a_Customer Information'))

WebUI.click(findTestObject('Object Repository/PhoneNumberStand_OR/Page_Blusalt - Start Testing your services/a_Phone Number Verification (Standard)'))
...
WebUI.verifyElementText(findTestObject('Object Repository/PhoneNumberStand_OR/Page_Blusalt - Start Testing your services/p_Phone Number Verified Successfully'), 
