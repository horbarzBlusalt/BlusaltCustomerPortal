...
WebUI.click(findTestObject('Object Repository/CustomerInfo_OR/Page_Blusalt - Start Testing your services/a_Know Your Customer (Basic)'))
...
WebUI.click(findTestObject('CustomerInfo_OR/Page_Blusalt - Start Testing your services/li_v2'))
